...
class ArucoSingleTracker():
    ...
    def track(self, frame, loop=True, verbose=False, show_video=None):
...
if __name__ == "__main__":
    ...
    aruco_tracker = ArucoSingleTracker(id_to_find=3, marker_size=10, show_video=False, camera_matrix=camera_matrix, camera_distortion=camera_distortion)
